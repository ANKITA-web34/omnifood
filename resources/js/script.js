$(document).ready(function () {
    ...
    $('.js--secetion-features').waypoint( function(direction) {
        if (direction == "down") {
            $('nav').addClass('sticky');
        }
        else {
        ...
        /*scroll-to-plan-price*/
    
    $('.js--srcollToPlans').click( function () {
        $('html, body').animate( {scrollTop: $('.js--section-plans').offset().top}, 1000);
    });
     $('.js--scrolltopbox').click( function () {
        $('html, body').animate( {scrollTop: $('.js--secetion-features').offset().top}, 1000);
    }); 
